      ...
      {loading ? (
        ...
        <>
          ...
          <div className="mb-6 p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg">
            <div className="text-sm text-gray-600">Total des utilisations</div>
          ...
          {stats?.toolsUsage && stats.toolsUsage.length > 0 ? (
            <div>
              <h3 className="text-sm font-semibold text-gray-700 mb-3">Outils les plus utilisés</h3>
            ...
            <div className="text-center py-8 text-gray-500">
              ...
              <p>Aucune utilisation pour cette période</p>
              <a
                href="/tools"
